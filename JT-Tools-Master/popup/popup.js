...
async function loadSettings() {
  try {
    ...
    document.getElementById('budgetQuickSum').checked = settings.budgetQuickSum !== undefined ? settings.budgetQuickSum : false;
...
async function getCurrentSettings() {
  ...
  return {
    ...
    budgetQuickSum: document.getElementById('budgetQuickSum').checked,
